    ...
    <div class="container">
        <div class="game-board">
                    ...
                    >
                        ...
                        <div class="contracts-status">
                            <span
                                ...
                                :class="{
                                    'contract-success':
                                        player.contractsStatus[idx]?.success,
                                    'contract-fail':
                                        player.contractsStatus[idx]?.success ===
                                        false,
                                    'contract-pending':
            ...
            <div v-else-if="gameOver">
                ...
                <p class="player-name">
                    Le gagnant est {{ winner.name }} avec
                    {{ winner.capital }} points !
                </p>
            </div>
        </div>
    </div>
...
,
        ...
        evaluateContract() {
            ...
            if (contractIsSuccessful) {
                this.currentPlayer.capital +=
                    this.currentPlayer.currentRoundPoints;
            } else {
                this.currentPlayer.capital = Math.floor(
                    this.currentPlayer.capital / 2
                );
            }
        ...
        undoDart() {
            if (this.gameHistory.length > 0) {
                ...
                if (
                    ...
                    this.currentPlayerIndex = previousState.currentPlayerIndex;
                    this.currentContractIndex =
                        previousState.currentContractIndex;
